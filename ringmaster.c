...
void game_setting(int sockfd, int num_players, int port_num, int *whole_players_fd, int * whole_players_port, char ** whole_players_ip){
...
int build_ringmaster_socket(int port_num){
    int status;
